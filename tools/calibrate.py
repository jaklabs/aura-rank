...
aura calibrate — fit the tier bands against a corpus of public repositories.
    ...
    THIS TOOL USES THE NETWORK. `aurarank/scan.py` DOES NOT.
...
from aurarank.scan import scan  # noqa: E402
...
def report(rows: list[dict]) -> dict:
    ...
    # meaning in aurarank/scan.py, and this function VALIDATES them instead.
    from aurarank.scan import TIERS
